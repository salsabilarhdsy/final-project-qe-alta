...
WebUI.click(findTestObject('WEB/Transactions/ViewByRows/select_15rows'))

WebUI.verifyElementNotPresent(findTestObject('WEB/Transactions/ViewByRows/16th_row'), 0)
