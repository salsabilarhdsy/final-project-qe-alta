...
name = WebUI.getText(findTestObject('WEB/Homepage/AddToCart/div_name'))
...
WebUI.verifyEqual(name, cName)

WebUI.verifyElementText(findTestObject('WEB/Homepage/AddToCart/jml_product'), '1')
