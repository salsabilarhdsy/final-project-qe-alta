...
Mobile.setText(findTestObject('MOBILE/Auth/Register/android.widget.EditText - Fullname'), 'Salsabila', 0)

Mobile.tap(findTestObject('MOBILE/Auth/Register/android.widget.EditText - Email'), 0)

Mobile.setText(findTestObject('MOBILE/Auth/Register/android.widget.EditText - Email'), 'iniemailsalsaa', 0)

Mobile.tap(findTestObject('MOBILE/Auth/Register/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('MOBILE/Auth/Register/android.widget.EditText - Password'), 'salsabila', 0)

Mobile.tap(findTestObject('MOBILE/Auth/Register/android.widget.Button - Register button'), 0)

Mobile.verifyElementVisible(findTestObject('MOBILE/Auth/Register/android.widget.Button - Register button'), 2)
