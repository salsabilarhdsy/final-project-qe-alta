...
Mobile.setText(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Email'), 'emailsl', 0)

Mobile.tap(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Password'), 'salsabila', 0)
