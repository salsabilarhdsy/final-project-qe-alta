...
Mobile.setText(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Email'), 'salsa@gmail.com', 0)

Mobile.tap(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('MOBILE/Auth/Login/android.widget.EditText - Password'), 'salsa', 0)
